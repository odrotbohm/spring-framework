 ...
 */
public abstract class CopyOfAbstractEntityManagerFactoryBean implements
	...
	protected static class SerializedEntityManagerFactoryBeanReference implements Serializable {
		...
		private Object readResolve() {
			return this.beanFactory.getBean(this.beanName, EntityManagerFactoryInfo.class).getEMFCreator();//, CopyOfAbstractEntityManagerFactoryBean.class);
		}
	}
	...
	protected static class ManagedEntityManagerFactoryInvocationHandler implements InvocationHandler, Serializable {
		...
		protected final CopyOfAbstractEntityManagerFactoryBean entityManagerFactoryBean;

		public ManagedEntityManagerFactoryInvocationHandler(CopyOfAbstractEntityManagerFactoryBean emfb) {
